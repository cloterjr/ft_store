import { Menu } from "../shared/model/security/menu";
...
export class MockData{
    ...
    [
      {
        id: 1,
        logo: "assets/images/site/renault_english_logo_desktop.png"
      }
    ];
    ...
    //Mock Roles
    static loadData(){
        this.visiter.push(this.menus[0]); // Added Permission to Home
        this.visiter.push(this.menus[1]); // Added Permission to Catalog

        this.client.push(this.menus[0]); // Added Permission to Home
        this.client.push(this.menus[1]); // Added Permission to Catalog

        this.admin.push(this.menus[0]); // Added Permission to Home
        this.admin.push(this.menus[1]); // Added Permission to Catalog
        this.admin.push(this.menus[2]); // Added Permission to Admin

        this.users = [
            { id: 1, name: 'Cloter Barbosa', userName: 'cloter', email: 'cloter@ciandt.com', document: '33297056800', password:'123',permissions: this.client},
            { id: 2, name: 'John Doe', userName: 'jdoe', email: 'jdoe@test.com', document: '12345678909', password:'123', permissions: this.visiter},
            { id: 3, name: 'Admin', userName: 'admin', email: 'admin@test.com', document: '12345678912', password:'123', permissions: this.admin}
          ];
    }
